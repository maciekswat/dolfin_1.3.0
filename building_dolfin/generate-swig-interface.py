...
# sys.path.insert(0,"d:\\source-46\\test-src\\site-packages\\")
...
# new code - works on windows in windows shell as well
scriptFullPath=os.path.abspath(__file__)
drive,path_and_file=os.path.splitdrive(scriptFullPath)

pathToFile,file=os.path.split(path_and_file)

script_rel_path=pathToFile

#original code
# script_rel_path = os.sep.join(__file__.split()[:-1])




print 'script_rel_path=',script_rel_path
...
def regenerate_swig_interface(module_to_submodules, excludes, top_destdir):
    """
